...
"""Before start enter your working folder"""
os.chdir('C:\\Vi-Fi scoring\\')
file_name= 'Sanger cluster1' # Enter file name, containing gene expression data for UMAP
n=15 #enter n_neighbors
method='correlation' #enter method for UMAP
groups = ['kidney', 'colon', 'NSCLC adeno', 'NSCLC other', 'SCLC', 'stomach'] #cell type groups
...
save_name=input('Figure name:') #name figure
plt.savefig(save_name+'.pdf') #save figure
